...
def main():
    ...
    provided_traj_filepath = args.traj_filepath if args.traj_filepath else scenario.task.traj_filepath
    scenario.task.traj_filepath = provided_traj_filepath
    ...
    data = pickle.load(open(scenario.task.traj_filepath, "rb"))
    meta_data = data['metadata']
    num_trajs = data['metadata']['num_trajectories']
    source_traj = data['source_robot']
    target_traj = data['target_robot']
